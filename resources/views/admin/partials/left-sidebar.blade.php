    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{ ($current_route == 'users.index' || $current_route == 'users.create') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{$current_route=='users.index' || $current_route=='users.create' ? 'active' : ''}} ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('users.create')}}" class="nav-link {{$current_route=='users.create' ? 'active' : ''}}">
                  <i class="far fas fa-user"></i>
